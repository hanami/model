...
describe Lotus::Model::AdapterRegistry do
  ...
  describe '#reset!' do
    before do
      ...
      registry.register(name: :cache, type: :memory, uri: nil)
  ...
  describe '#register' do
    ...
    describe 'when default parameter is set' do
      it 'adds new adapter default' do
        ...
        registry.register(name: :sqlite3, type: :sql, uri: SQLITE_CONNECTION_STRING)
        registry.register(name: :cache, type: :memory, uri: nil, default: true)
